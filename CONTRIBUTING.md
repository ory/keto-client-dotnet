...
# Contributing to Ory Ory Keto Dotnet Client
...
_Please note_: We take Ory Ory Keto Dotnet Client's security and our users' trust very seriously. If you believe you have found a security issue
in Ory Ory Keto Dotnet Client, please responsibly disclose by contacting us at security@ory.sh.
...
Ory Keto Dotnet Client's normal direction. A great way to
do this is via
[Ory Ory Keto Dotnet Client Discussions](https://github.com/orgs/ory/discussions) or the
[Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/keto-client-dotnet/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get [answers to questions regarding Ory Ory Keto Dotnet Client?](#communication)
...
- I want to talk to other Ory Ory Keto Dotnet Client users. [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  Ory Keto Dotnet Client.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/keto-client-dotnet)

- I would like updates about new versions of Ory Ory Keto Dotnet Client.
...
[list of good first issues](https://github.com/ory/keto-client-dotnet/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a difference. This is something that everyone can do to help
  out Ory Ory Keto Dotnet Client. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for Ory Ory Keto Dotnet Client and some of them may lack necessary information,
...
Check out [Ory Ory Keto Dotnet Client Discussions](https://github.com/orgs/ory/discussions). This is a great place for in-depth discussions and lots of code examples, logs
and similar data.
...
If you want to receive regular notifications about updates to Ory Ory Keto Dotnet Client, consider joining the mailing list. We will _only_ send
...
[in our chat](https://www.ory.sh/chat) before getting started to ensure your work is consistent with Ory Ory Keto Dotnet Client's roadmap and
architecture.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform commit history and helps structure the changelog.  
   Please refer to this [list of prefixes for Ory Keto Dotnet Client](https://github.com/ory/keto-client-dotnet/blob/master/.github/semantic.yml) for an
   overview.
...
[Contributor License Agreement](https://cla-assistant.io/ory/keto-client-dotnet).
...
5. have signed our [Contributor License Agreement](https://cla-assistant.io/ory/keto-client-dotnet);
...
[docs](https://github.com/ory/keto-client-dotnet/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to [docs/README.md](https://github.com/ory/keto-client-dotnet/blob/master/README.md).
...
git clone git@github.com:ory/ory/keto-client-dotnet.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/keto-client-dotnet.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel you have been or are being harassed or made
  uncomfortable by a community member, please contact one of the channel ops or a member of the Ory Ory Keto Dotnet Client core team
  immediately.
